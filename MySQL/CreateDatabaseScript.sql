...
CREATE TABLE IF NOT EXISTS `radnja`.`user` (
  ...
  `user_isActive` TINYINT(4) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `radnja`.`passpartucolor` (
  ...
  `passpartu_passpartu_oid` INT(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `radnja`.`invoiceitem` (
  ...
  `invoiceitem_count` INT(11) NULL DEFAULT NULL,
  ...
  `glass_glass_oid` INT(11) NULL DEFAULT NULL,
  `mirror_mirror_oid` INT(11) NULL DEFAULT NULL,
  `faceting_faceting_oid` INT(11) NULL DEFAULT NULL,
  `sanding_sanding_oid` INT(11) NULL DEFAULT NULL,
  `invoiceitem_passpartuWidth` DECIMAL(20,3) NULL DEFAULT NULL,
  `invoiceitem_passpartuWidthUom` VARCHAR(45) NULL DEFAULT NULL,
  `passpartucolor_passpartuColor_oid` INT(11) NULL DEFAULT NULL,
